  ...
  return (
    <Swiper
      ...
      <div className="swiper-button-next">
        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none" className='w-full h-auto'>
